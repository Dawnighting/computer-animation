...
def update_fk(id_lst: ti.template(), local_mat_field: ti.template(), 
    ...
    for i in range(length):
        ...
        # 非根节点
            ...
            global_mat_field[i] = global_mat_field[id_lst[i]] @ local_mat_field[i]
        global_position[i] == vec3(
            global_mat_field[i][0 , 3], global_mat_field[i][1 , 3], global_mat_field[i][2 , 3]
        )